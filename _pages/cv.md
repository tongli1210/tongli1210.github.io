...
Education
======
* Ph.D in Biomedical Engineering, Georgia Institute of Technology and Emory University, 2020 
  * Advisor: Professor May D. Wang, Ph.D., IEEE Fellow
  * Thesis: “Enable precision medicine by integrating multimodal biomedical data.”
* B.S. in Biomedical Engineering, Peking University, 2014
  * Academic Performance: Top 5%

Work Experience
======
* Dec. 2025 - Present: Assistant Professor
...
* Aug. 2021 - Nov. 2025: Staff Engineer (Medical Imaging Analysis/Machine Learning)
  ...
  * Led a team of fifteen engineers as the technical leader (six Ph.D. and seven Master’s), driving AI-enpowered technology and application development for MRI systems.
  * Successfully developed products that are widely deployed across United Imaging’s full range of 1.5T, 3T, and 5T MRI devices, providing high-quality and efficient medical imaging services to a large number of patients worldwide.
  * Collaborated closely with multiple leading hospitals and research institutions, resulting in over 20 domestic and international patents.

* Aug. 2014 - Dec. 2020: Graduate Research Assistant
  * Georgia Institute of Technology and Emory University, Atlanta, GA, USA
  * Supervisor: Professor May D. Wang
  * Multi-Modality Biomedical Data Integration
    * Designed deep autoencoders to combine medical images (MRI & PET) with genomics and electronic health records (EHRs) for accurate diagnosis of Alzheimer’s Disease (AD).
    * Developed a cross-modality translation network to integrate multi-omics data for cancer survival analysis.
    * Designed a divergence-based consensus learning method to learn modality-invariant representation.
    * Proposed a gene embedding-based collaborative filtering framework for multi-omics data integration.
  * Medical Imaging Analysis
    * Developed a convolutional autoencoder for semi-supervised learning of endomicroscopic images for improved diagnosis of Barrett’s Esophagus (BE).
...
* Summer 2018 & 2019: Summer Intern (Medical Imaging Analysis/Machine Learning)
  ...
  * Deep Learning based CT Images Segmentation for Lung Blood Vessels(May 2019 - Aug 2019)
    ...
    * Developed adversarial training to regularize the network with Wasserstein distance or multi-scale L1 loss.
  * Partial 3D Reconstruction with Digital Tomosynthesis (DTS)(May 2018 - Aug 2018)
    * Implemented a pipeline for C-arm X-ray camera calibration and pose estimation with 2D fiducial markers.
    * Implemented partial 3D chest X-ray reconstruction with the shift-and-add (SAA) algorithm and the simultaneous algebraic reconstruction technique (SART).
...
Honors and Awards
======
* Company-Level Outstanding Team Award, Shanghai United Imaging Healthcare, 2024
* MRI BU Outstanding Individual Award, Shanghai United Imaging Healthcare, 2023
* MRI BU Outstanding Team Award, Shanghai United Imaging Healthcare, 2023
* IEEE BSN/BHI Travel Award, Mar 2018
* IEEE BHI 2018 Big Data Competition Awards 1st Award, Mar 2018
* Ph.D. Scholarship, China Scholarship Council (CSC), July 2014
* Undergraduate Exchange Scholarship, China Scholarship Council (CSC), Jan 2014
* Jinlongyu Scholarship (Top 5%), Peking University, Sept 2013
* Model Student of Academic Records (Top 5%), Peking University, Sept 2013
* Xiashouyu-Huangyuceng Scholars (Top 10%), Peking University, Apr 2012
* Junzheng Foundation Research Fellowship (Top 10%), Peking University, Apr 2012
* POSCO Fellowship (Top 5%), Peking University, Sept 2011
* Jiangzehan Mathematical Modeling Contest Third Prize, Peking University, June 2011

Service and leadership
======
* Young Professional Activities Co-Chair for IEEE Healthcare Summit (IHS), 2021
* Webmaster, IEEE The International Conference on Biomedical and Health Informatics (BHI), 2017
* Webmaster, The ACM Conference on Bioinformatics, Computational Biology, and Health Informatics(ACM-BCB), 2015
* Volunteer, 2015 ACM-BCB conference, Atlanta, Georgia (three days in Sept. 2015)
* Student activity co-chair, 2015 ACM-BCB conference, Atlanta, Georgia (three days in Sept. 2015)
* Volunteer, 2014 Gensips conference, Atlanta, Georgia (two days in Dec. 2014)
* Secretary of Youth-Volunteer Association at College of Engineering, Peking University, 2012-2013
* Voluntary teaching for disabled children in Beijing, Peking University, 2012-2013
* Advisor for freshmen, Peking University, 2012-2013

Skills
======
* Language: Mandarin Chinese and English
* Programming Languages: Python, MATLAB, and C/C++
* Others: Shell, TensorFlow, PyTorch, LlamaFactory, and LaTeX